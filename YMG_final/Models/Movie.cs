...
namespace YMG.Models
{
    public class Movie
    {
        ...
        [Required, RegularExpression(@"^[a-zA-Z\s\,\.\'\-]*$", ErrorMessage = "The description should only contain letters, spaces or the characters: , . ' -"), MinLength(2, ErrorMessage = "Director's name should be at least 2 characters long."), MaxLength(30, ErrorMessage = "Director's name should be at most 30 characters long.")]
